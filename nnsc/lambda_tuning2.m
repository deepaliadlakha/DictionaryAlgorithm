function [error_val1,lambda_val]=lambda_tuning2(dictsize,maxIter,numDisplay,p)
...
%     dataSelected=data_barbara;
    ...
    display_dictionary(dataSelected(:,1:10),8,5);colorbar;
    pause
    ...
    norm(data_old-dataSelected,'fro')/numel(data_old)
    pause
...
%     dataSelected=normc(dataSelected);
    ...
    lambda_val=[0,0.01,0.1,0.3,0.5,0.7,1,1.5];
